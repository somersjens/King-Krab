...
#ifndef KING_KRAB_SWIFT_H
#define KING_KRAB_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="King_Krab",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9King_Krab8AppAudio")
...
@class AVAudioPlayer;
@interface AppAudio (SWIFT_EXTENSION(King_Krab)) <AVAudioPlayerDelegate>
...
SWIFT_CLASS("_TtC9King_Krab11AppDelegate")
...
SWIFT_CLASS("_TtC9King_Krab19NotificationManager")
...
@interface NotificationManager (SWIFT_EXTENSION(King_Krab)) <UNUserNotificationCenterDelegate>
...
SWIFT_CLASS("_TtC9King_Krab13PromoRecorder")
@interface PromoRecorder : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
