...
extension ImageResource {
    ...
    /// The "app_icon_trailer" asset catalog image resource.
    static let appIconTrailer = ImageResource(name: "app_icon_trailer", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "app_icon_trailer" asset catalog image.
    static var appIconTrailer: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .appIconTrailer)
#else
        .init()
#endif
    }
...
extension UIKit.UIImage {
    ...
    /// The "app_icon_trailer" asset catalog image.
    static var appIconTrailer: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .appIconTrailer)
#else
        .init()
